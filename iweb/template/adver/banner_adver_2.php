...
?>
 <div class="bg-gold text-dark mt-5">
  <div class="container-md">
    <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
      <div class="col-12 col-md-6 py-3">
                          <h3 class="fw-semibold">رنگ زنده</h3>
                          <h4 class="mb-4">با روزهای خاکستری با سایه های رنگین کمانی مبارزه کنید</h4>
      ...
      <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          ...
          <img class="lazy-image position-absolute top-0 w-100" data-src="./itemplates/iweb/media/men/men-b.webp" alt="">
          </div>
      </div>
    </div>
  </div>
...
<div class="container-fluid py-5 bg-gold-light">
<div class="row">
    ...
    <div class="owl-center-nonloop owl-carousel">
            <div class="item position-relative">
             ...
             <a href="#" class="text-decoration-none">
              <div class="card text-dark rounded-0 border-0 bg-transparent">
                ...
                <img data-src="./itemplates/iweb/media/men/men-b1.webp" class="card-img rounded-0 owl-lazy" alt="...">
            ...
            <div class="item position-relative">
             ...
             <a href="#" class="text-decoration-none">
              <div class="card text-dark rounded-0 border-0 bg-transparent">
                <div class="position-relative">
                <img data-src="./itemplates/iweb/media/men/men-b2.webp" class="card-img rounded-0 owl-lazy" alt="...">
                ...
                <section>
                  <div class="hstack gap-3"><h6 class="fw-semibold">۳،۴۰۰،۰۰۰ تومان</h6><h6><del>۵،۴۰۰،۰۰۰ تومان</del></h6></div>
                </section>
              </div>
             </a>
            </div>
            <div class="item position-relative">
             ...
             <a href="#" class="text-decoration-none">
              <div class="card text-dark rounded-0 border-0 bg-transparent">
                <div class="position-relative">
                <img data-src="./itemplates/iweb/media/men/men-b3.webp" class="card-img rounded-0 owl-lazy" alt="...">
                </div>
                <div class="card-body p-0 py-2">
            ...
            <div class="item position-relative">
             ...
             <a href="#" class="text-decoration-none">
              <div class="card text-dark rounded-0 border-0 bg-transparent">
                <div class="position-relative">
                <img data-src="./itemplates/iweb/media/men/men-b4.webp" class="card-img rounded-0 owl-lazy" alt="...">
                </div>
                <div class="card-body p-0 py-2">
                  <h6 class="m-0 text-truncate">HOSBJERG</h6>
                  <h6 class="m-0 text-truncate">شلوار ALEXA CUFF - شلوار - آبی</h6>
            ...
            <div class="item position-relative">
             ...
             <a href="#" class="text-decoration-none">
              <div class="card text-dark rounded-0 border-0 bg-transparent">
                <div class="position-relative">
                <img data-src="./itemplates/iweb/media/men/men-b5.webp" class="card-img rounded-0 owl-lazy" alt="...">
                </div>
                <div class="card-body p-0 py-2">
                  <h6 class="m-0 text-truncate">HOSBJERG</h6>
                  <h6 class="m-0 text-truncate">شلوار ALEXA CUFF - شلوار - آبی</h6>
            ...
            <div class="item position-relative">
             ...
             <a href="#" class="text-decoration-none">
              <div class="card text-dark rounded-0 border-0 bg-transparent">
                <div class="position-relative">
                <img data-src="./itemplates/iweb/media/men/men-b6.webp" class="card-img rounded-0 owl-lazy" alt="...">
                </div>
                <div class="card-body p-0 py-2">
                  <h6 class="m-0 text-truncate">HOSBJERG</h6>
                  <h6 class="m-0 text-truncate">شلوار ALEXA CUFF - شلوار - آبی</h6>
