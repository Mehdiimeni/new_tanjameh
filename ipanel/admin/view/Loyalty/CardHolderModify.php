                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="FirstName" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->FirstName; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["family"]; ?>
                                            <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="LastName" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->LastName; ?>">
                                        </div>
                                    </div>
