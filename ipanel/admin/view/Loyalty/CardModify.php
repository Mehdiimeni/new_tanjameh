                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["card_holder"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="CardHolderId" class="form-control" required="required">
                                                <?php echo $strCardHolderId; ?>
                                            </select>
                                        </div>
                                    </div>
