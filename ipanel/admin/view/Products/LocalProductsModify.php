                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input name="ProductType" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->ProductType; ?>">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input name="BrandName" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->BrandName; ?>">
                            </select>
                        </div>
                    </div>
