                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["operator"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["charge"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <select name="Amount" class="form-control" required="required">
                                                    <?php echo $strType; ?>
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["charge_type"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <select name="TopupType" class="form-control" required="required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input name="CellNumber" class=" form-control col-md-7 col-xs-12"
                                                       required="required" type="text" minlength="11" maxlength="11"
                                                       data-inputmask="'mask' : '09999999999'">
                                            </div>
                                        </div>
                                    </div>
