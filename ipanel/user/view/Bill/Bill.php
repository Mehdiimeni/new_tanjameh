...
<head>
    ...
    <link href="<?php echo(IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css"
          rel="stylesheet">
    <!-- PNotify -->
    <link href="<?php echo(IW_PANEL_THEME_FROM_PANEL); ?>vendors/pnotify/dist/pnotify.css" rel="stylesheet">
    <link href="<?php echo(IW_PANEL_THEME_FROM_PANEL); ?>vendors/pnotify/dist/pnotify.buttons.css" rel="stylesheet">
    <link href="<?php echo(IW_PANEL_THEME_FROM_PANEL); ?>vendors/pnotify/dist/pnotify.nonblock.css" rel="stylesheet">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <?php (new FileCaller)->FileIncluderWithControler(IW_PANEL_FROM_PANEL . 'user/', 'GlobalPage', 'ListTableType'); ?>
                                <thead>
...
<!-- PNotify -->
<script src="<?php echo(IW_PANEL_THEME_FROM_PANEL); ?>vendors/pnotify/dist/pnotify.js"></script>
<script src="<?php echo(IW_PANEL_THEME_FROM_PANEL); ?>vendors/pnotify/dist/pnotify.buttons.js"></script>
<script src="<?php echo(IW_PANEL_THEME_FROM_PANEL); ?>vendors/pnotify/dist/pnotify.nonblock.js"></script>
<script>

    function init_PNotify() {
        "undefined" != typeof PNotify && (console.log("init_PNotify"), new PNotify({
            title: "<?php echo FA_LC["bill_modify_page_note_title"]; ?>",
            type: "error",
            text: "<?php echo FA_LC["bill_modify_page_note"]; ?>",
            nonblock: {nonblock: !0},
            styling: "bootstrap3",
            hide: !1,
            sound: true,
