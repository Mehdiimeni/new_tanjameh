                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["bill_id"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="BillId" class=" form-control col-md-7 col-xs-12"
                                                   required="required" type="text" tabindex="1"
                                                   data-inputmask="'mask' : '9999999999999'">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["pay_id"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="PayId" class=" form-control col-md-7 col-xs-12"
                                                   required="required" type="text" tabindex="2"
                                                   data-inputmask="'mask' : '9999999999999'">
                                        </div>
                                    </div>
                                    ...
                                    <?php if (@$objGlobalVar->JsonDecode($objGlobalVar->GetVarToJsonNoSet())->modify != 'view') { ?>
                                        <div class="form-group">
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                <button type="submit" tabindex="3" name="SubmitM" value="A"
                                            ...
                                            <form class="form-horizontal form-label-left input_mask" method="post"
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><label><?php echo FA_LC["bill_id"]; ?></label></td>
                                                        <td><input name="BillId"
                                                                   class=" form-control col-md-7 col-xs-12"
                                                                   readonly type="text" value="<?php echo($BillId); ?>">
                                                        </td>
                                                        <td><label><?php echo FA_LC["pay_id"]; ?></label></td>
                                                        <td><input name="PayId" class=" form-control col-md-7 col-xs-12"
                                                                   readonly type="text" value="<?php echo($PayId); ?>">
                                                        </td>

                                                    </tr>
                                                    <tr>

                                                        <td><label><?php echo FA_LC["bill_type"]; ?></label></td>
                                                        <td><?php echo $strBillType; ?></td>
                                                        <td><label><?php echo FA_LC["bill_price"]; ?></label></td>
                                                        <td><?php echo $intPay; ?></td>
                                                    </tr>
                                                ...
                                                <?php if (@$objGlobalVar->JsonDecode($objGlobalVar->GetVarToJsonNoSet())->modify != 'view') { ?>
                                                    <div class="form-group">
                                                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                            <button type="submit" tabindex="4" name="SubmitA" value="A"
                                                                    class="btn btn-success"><?php echo FA_LC["payment"]; ?></button>
                                                            <button type="reset"
                                                                    class="btn btn-primary"><?php echo FA_LC["cancel"]; ?></button>
                                                        </div>
                                                    </div>
