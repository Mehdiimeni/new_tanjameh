                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["from_card_number"]; ?>
                                            <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="FromCardNumber" class=" form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   data-inputmask="'mask' : '9999-9999-9999-9999'"
                                                   value="<?php echo @$objEditView->FromCardNumber; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["to_card_number"]; ?>
                                            <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="ToCardNumber" class=" form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   data-inputmask="'mask' : '9999-9999-9999-9999'"
                                                   value="<?php echo @$objEditView->ToCardNumber; ?>">
                                        </div>
                                    </div>
