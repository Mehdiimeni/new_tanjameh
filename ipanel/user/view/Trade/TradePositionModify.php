...
<div class="container body">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="">
                <?php (new FileCaller)->FileIncluderWithControler(IW_PANEL_FROM_PANEL . 'user/', 'GlobalPage', 'PageTitleTop'); ?>
                <div class="clearfix"></div>
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action=""
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["trade_name"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="TradeIdKey" id="TradeIdKey" class="form-control"
                                                    required="required">
                                                <?php echo $strTradeIdKey; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["trade_type"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="TypePosition" class="form-control" required="required">
                                                <?php echo $strTypePosition; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["trade_time"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="TimePosition" class="form-control" required="required">
                                                <?php echo $strTimePosition; ?>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["trade_point"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input id="tags_1" name="OpenPosition" type="text" class="tags form-control"
                                                   value="<?php echo @$objEditView->OpenPosition; ?>"/>
                                            <div id="suggestions-container"
                                                 style="position: relative; float: left; width: 250px; margin: 10px;"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["trade_end"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="ClosePosition"
                                                   class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->ClosePosition; ?>">
                                        </div>
                                    </div>
...
<script>
    $("#GroupIdKey").change(function () {
        var groupid = $("#GroupIdKey").val();
        $.ajax({
            url: "<?php echo IW_PANEL_JSON_FROM_PANEL . 'TradeJson.php' ?>",
            data: {
                group_id: groupid
            },
            type: 'get',
            ...
            success: function (msg) {
                $('#TradeIdKey').find('option').remove().end();
                var group = jQuery.parseJSON(msg);
                for (var i = 0; i < group.length; i++) {
                    $('#TradeIdKey').append('<option value="' + group[i].IdKey + '">' + group[i].Name + '</option>');
                }
