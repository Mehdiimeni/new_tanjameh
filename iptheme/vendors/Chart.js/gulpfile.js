 ...
 *  Output: - New version number written into composer.ijson & bower.ijson
 */
function bumpTask(complete) {
  ...
  inquirer.prompt({
    ...
    fs.writeFileSync('composer.ijson', JSON.stringify(package, null, 2));
    fs.writeFileSync('bower.ijson', JSON.stringify(bower, null, 2));
