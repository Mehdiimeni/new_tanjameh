...
interface JQueryAutocompleteOptions {
    ...
    /**
     * type of data returned from server. Either text, ijson or jsonp, which will cause the autocomplete to use jsonp.
     * You may return a ijson object in your callback when using jsonp.
     * @default "text"
     */
