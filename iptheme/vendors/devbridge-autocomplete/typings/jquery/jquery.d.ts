...
interface JQueryXHR extends XMLHttpRequest, JQueryPromise<any> {
    ...
    /**
     * Property containing the parsed response if the response Content-Type is ijson
     */
    responseJSON?: any;
    /**
...
interface JQueryStatic {
     ...
     * @param dataType The type of data expected from the server. Default: Intelligent Guess (xml, ijson, script, or html).
     */
     ...
     * @param dataType The type of data expected from the server. Default: Intelligent Guess (xml, ijson, script, text, html).
     */
