...
function init_cropper() {
    if ("undefined" != typeof $.fn.cropper) {
        ...
        var e = $("#image"), a = $("#download"), t = $("#dataX"), n = $("#dataY"), o = $("#dataHeight"),
            i = $("#dataWidth"), r = $("#dataRotate"), l = $("#dataScaleX"), s = $("#dataScaleY"), c = {
    ...
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#canvasRadar").length) {
            var e = document.getElementById("canvasRadar"), a = {
                labels: [ "امتیاز", "ورود", "قبض", "شارژ", "اعتبار"],
                datasets: [{
                    label: "My First dataset",
...
function init_DataTables() {
    if (console.log("run_datatables"), "undefined" != typeof $.fn.DataTable) {
        ...
        }(), $("#datatable").dataTable({language: {url: "//cdn.datatables.net/plug-ins/1.10.19/i18n/Persian.json"}}), $("#datatable-keytable").DataTable({
            keys: !0,
            language: {url: "//cdn.datatables.net/plug-ins/1.10.19/i18n/Persian.json"}
        }), $("#datatable-responsive").DataTable({language: {url: "//cdn.datatables.net/plug-ins/1.10.19/i18n/Persian.json"}}), $("#datatable-scroller").DataTable({
            language: {url: "//cdn.datatables.net/plug-ins/1.10.19/i18n/Persian.json"},
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        if ($("#echart_pie").length) {
            ...
            var d = {normal: {label: {show: !1}, labelLine: {show: !1}}}, u = {
...
function lock_screen() {
    setInterval(function () {
        var e = new Date, a = e.getHours(), t = e.getMinutes(), n = e.getSeconds();
